...
public class Registro extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Tabla.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nombre", "Clicks", "Tiempo", "Conclusion"
            }
        ));
        ...
        jLabel13.setText("Registro de jugadores");
        ...
        jButton8.setText("VOLVER A JUGAR");
 ...
 private void eliminarFilaSeleccionada() {
    ...
    if (filaSeleccionada != -1) { // Si hay una fila seleccionada
        model.removeRow(filaSeleccionada); // Elimina la fila seleccionada del modelo de la tabla
    } else {
        // Si no hay una fila seleccionada, muestra un mensaje o realiza alguna otra acción
 ...
 private void eliminarTodosLosDatos() {
    DefaultTableModel model = (DefaultTableModel) Tabla.getModel();
    model.setRowCount(0); // Establece el número de filas en cero, eliminando así todos los datos de la tabla
}
